...
from src.utils import (api_currency, api_stock, begin_of_month, card_operations, currency_rate, date_now, greeting,
                       read_file, stock_rate, top_5_operations)
...
def test_card_operations_no_expenses_returns_empty():
    ...
    assert result == {"Сумма операции с округлением": {}, "Кэшбэк": {}}
...
def test_api_stock_returns_parsed_result():
    fake_json = {"Global Quote": {"05. price": "181.23"}}
