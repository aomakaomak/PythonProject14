...
def test_benefit_categories_returns_correct_json():
    ...
    df = pd.DataFrame(
        {
            "Дата операции": ["01.06.2024 12:00:00", "05.06.2024 15:00:00", "15.07.2024 10:00:00"],
...
def test_benefit_categories_returns_empty_when_no_data():
    ...
    df = pd.DataFrame({"Дата операции": ["01.05.2024 12:00:00"], "Категория": ["Продукты"], "Кэшбэк": [10.0]})
